  ...
  return (
    <header className="sticky top-0 z-10 flex items-center justify-between border-b border-gray-50 bg-white/80 px-8 py-4 backdrop-blur">
      ...
      <div className="flex items-center gap-4">
        ...
        <button aria-label="Notifications" className="relative rounded-full p-2 text-gray-400 hover:bg-gray-50 hover:text-gray-600"><Bell className="h-5 w-5" /><span className="absolute right-1.5 top-1.5 h-2 w-2 rounded-full bg-orange-500" /></button>
