...
export default function MobileTopHeader() {
  return (
    <header className="lg:hidden w-full bg-white px-5 py-4 flex items-center justify-between border-b border-gray-100 sticky top-0 z-40">
      {/* Brand Logo on Left */}
      ...
      {/* Quick Action Suite on Right */}
      <div className="flex items-center gap-4">
        <button className="p-1.5 text-gray-500 hover:text-green-800 transition-colors">
        ...
        <button className="p-1.5 text-gray-500 hover:text-green-800 transition-colors relative">
