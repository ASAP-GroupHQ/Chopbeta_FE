  ...
  return (
    <section className="w-full bg-[#1E6B3C] rounded-[24px] overflow-hidden p-6 sm:p-8 lg:p-10 relative flex items-center min-h-[200px] sm:min-h-[240px] lg:min-h-[260px] shadow-sm">
      <div className="relative z-10 text-white max-w-[60%] sm:max-w-[55%] md:max-w-[50%] space-y-4">
        ...
        <p className="text-green-50/80 mb-8 text-xs sm:text-sm font-medium max-w-[280px] sm:max-w-[340px]">
          Tell us your budget and we will handle the rest.
        </p>

        <button className="group flex items-center gap-2 bg-white text-[#1A2E35] font-bold px-5 py-3 mt-4 sm:mt-6 rounded-xl text-xs sm:text-sm hover:bg-gray-50 transition-all active:scale-[0.98] shadow-sm cursor-pointer">
          Generate Meal Plan
          <svg
            width="18"
            height="14"
