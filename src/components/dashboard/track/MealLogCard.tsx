...
export const MealLogCard: React.FC<MealLogCardProps> = ({
  ...
  return (
    <div className="w-full bg-white rounded-2xl p-4 border border-gray-100 shadow-sm flex items-center justify-between transition-all duration-300 hover:shadow-md">
      {/* Left Section: Status Dot & Meal Details (No Image) */}
      ...
      <div className="flex items-center gap-3 pl-2 flex-shrink-0">
        ...
        <button
          ...
          className={`w-7 h-7 sm:w-8 sm:h-8 rounded-full flex items-center justify-center transition-all duration-200 focus:outline-none border-2 cursor-pointer ${
            meal.eaten
