...
export const StatCard: React.FC<StatCardProps> = ({
  ...
  return (
    <div className="bg-white rounded-2xl p-5 shadow-sm border border-gray-50 flex flex-col justify-between h-[115px] transition-all hover:shadow-md duration-300">
      ...
      <div className="w-full mt-3">
        {progressColor && progressWidth ? (
          <div className="space-y-2">
            ...
            <span className="text-[11px] text-gray-500 block">{subtext}</span>
          </div>
        ) : (
          <span className="text-[11px] text-gray-500 block">{subtext}</span>
        )}
